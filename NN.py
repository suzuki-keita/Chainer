...
train, valid = datasets.split_dataset_random(datasets.TupleDataset(train_X, train_Y), 1800, seed=SEED)
train_iter = iterators.SerialIterator(train, batchsize)
...
filename = "result_NN_" + datetime.datetime.now().strftime('%Y-%m-%d_%H-%M-%S')
